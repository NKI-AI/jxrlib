...
**Note**: This is a vendored version of [jxrlib](https://github.com/4creators/jxrlib). The code has been modified to build on the newer platforms, and a bazel toolchain has been added. Below is the original README.
